...
// node_modules/.pnpm/@vueuse+core@6.9.2_vue@3.2.22/node_modules/@vueuse/core/index.mjs
init_define_DEMOBLOCK_LOCALES();
init_define_MZ_ZOOM_OPTIONS();

// node_modules/.pnpm/@vueuse+shared@6.9.2_vue@3.2.22/node_modules/@vueuse/shared/index.mjs
init_define_DEMOBLOCK_LOCALES();
init_define_MZ_ZOOM_OPTIONS();
init_lib();
function and(...args) {
...
function useDebouncedRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(source, __spreadProps$42(__spreadValues$9({}, options), { eventFilter: filter }));
...
var __objRest$22 = (source, exclude) => {
  var target = {};
  for (var prop in source)
    if (__hasOwnProp$92.call(source, prop) && exclude.indexOf(prop) < 0)
      target[prop] = source[prop];
  if (source != null && __getOwnPropSymbols$92)
    for (var prop of __getOwnPropSymbols$92(source)) {
      if (exclude.indexOf(prop) < 0 && __propIsEnum$92.call(source, prop))
        target[prop] = source[prop];
    }
  return target;
};
  ...
  function useFactoryFetch(url, ...args) {
    ...
    if (args.length > 0) {
      if (isFetchOptions(args[0])) {
        options = __spreadValues$72(__spreadValues$72({}, options), args[0]);
      } else {
        fetchOptions = __spreadProps$22(__spreadValues$72(__spreadValues$72({}, fetchOptions), args[0]), {
          headers: __spreadValues$72(__spreadValues$72({}, headersToObject(fetchOptions.headers) || {}), headersToObject(args[0].headers) || {})
        });
      }
    }
    if (args.length > 1 && isFetchOptions(args[1]))
      options = __spreadValues$72(__spreadValues$72({}, options), args[1]);
...
function useFetch(url, ...args) {
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    if (supportsAbort) {
      ...
      fetchOptions = __spreadProps$22(__spreadValues$72({}, fetchOptions), {
    ...
    return new Promise((resolve, reject) => {
      var _a3;
      fetch(context.url, __spreadProps$22(__spreadValues$72(__spreadValues$72({}, defaultFetchOptions), context.options), {
        headers: __spreadValues$72(__spreadValues$72({}, headersToObject(defaultFetchOptions.headers)), headersToObject((_a3 = context.options) == null ? void 0 : _a3.headers))
